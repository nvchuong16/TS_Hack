...
function menuescolhas2(menu_tipo)
    ...
    if menu_tipo == 1 then
        MNV = gg.choice({'🌟 • Unlock Gold Pass', '⏳ • Freeze Reward', '💣 • Items', "🎉 • Skins",
                         ...
                         '⚓ • Stickers', '🏭 • Poster', "☢️ • construction and barn", '🎉 • Badge',
    ...
    elseif menu_tipo == 22987 then
        MYU = gg.choice({'💎 • Badge 1', '💎 • Badge 2', '💎 • Badge 3', '💎 • Badge 4',
                         '💎 • Badge 5', '💎 • Badge 6', '❌ • Return'}, nil, 'CHOOSE ONE OPTION')
        if MYU == nil then
            return
        end
        if MYU == 1 then
    ...
    elseif menu_tipo == 6 then
        MNF = gg.choice({'🍀 • XP (Wheat)', '📦 • City Market', '🏭 • Industry Academy',
                         ...
                         '🛬 • Plane return to base', '🃏✉️🪧📩🚃 • train card', '🚀 • Heli Auto',
                         '💺 • Airplane Auto', '👾 • Freeze Population', '❌ • Return'}, nil,
            [[]])
    ...
    elseif menu_tipo == 101 then
        MaxJES_1 = gg.choice({"🛰️ • Skin 1 Gatsby Island Palace", "🚀 • Skin 2 Gatsby Island Mansion",
                              ...
                              "☃️ • Skin 13 Witch's Mansion", "☃️ • Skin 14 Witch's Castle",
                              '❌ • Return'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 102 then
        MaxJES_2 = gg.choice({"🚁 • Skin 1 Helicopter", "🚁 • Skin 2 Super Delivery Robot",
                              ...
                              "🚁 • Skin 12 Flying Basticapho", "🚁 • Skin 13 Pirate",
                              "🚁 • Skin 14 Holiday", "🚁 • Skin 15 Gala", "🚁 • Skin 16 Space",
                              "🚁 • Skin 17 Santa's Sleigh", "🚁 • Skin 18 Eggplant",
                              "🚁 • Skin 19 Pumpkin-Chopper", "🚁 • Skin 20 Surveillance Blimp",
                              "🚁 • Skin 21 Flying Cauldron", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 103 then
        MaxJES_3 = gg.choice({"🚁 • Skin 1 Holiday Helipad", "🚁 • Skin 2 Nomads' Harbor Helipad",
                              ...
                              "🚁 • Skin 17 Easter Helipad", "🚁 • Skin 18 Sunken Palace Helipad",
    ...
    elseif menu_tipo == 105 then
        MaxJES_5 = gg.choice({"🛰️ • Express Gate Station Skin 1", "🚀 • Haunted Station Skin 2",
                              ...
                              "☃️ • Christmas Station Skin 17", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 106 then
        MaxJES_6 = gg.choice({"🛬 • Rocket Plane Skin 1", "🛬 • Super Rocket Plane Skin 2",
                              ...
                              "🛬 • Rock Plane Skin 5", "🛬 • Aero Plane Skin 6",
                              "🛬 • Frosted Plane Skin 7", "🛬 • Lucky Plane Skin 8",
                              "🛬 • Arabian Plane Skin 9", "🛬 • Fashion Plane Skin 10",
                              "🛬 • Stealth Plane Skin 11", "🛬 • Seaplane Skin 12",
                              "🛬 • Festive Plane Skin 13", "🛬 • Spectral Plane Skin 14",
                              "🛬 • Avian Plane Skin 15", "🛬 • Flying Triene Plane Skin 16",
                              "🛬 • Symphonic Plane Skin 17", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 107 then
        MaxJES_7 = gg.choice({"🛬 • Skin 1 Rocker Airport", "🛬 • Skin 2 Sweet Airport",
                              ...
                              "🛬 • Skin 15 Ski Resort Airport", '❌ • Return'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 109 then
        MaxJES_9 = gg.choice({"🛰️ • Skin 1 Tropical Port", "🚀 • Skin 2 Pirate Port",
                              "⚓ • Skin 3 Classic Port", "🎯 • Skin 4 Jungle Port",
                              "🛬 • Skin 5 Viking Port", "🚁 • Skin 6 Christmas Port",
                              "☃️ • Skin 7 Port Tavern Port", "🚁 • Skin 8 Sugar Port",
                              "☃️ • Skin 9 Creepy Port", "🚁 • Skin 10 Holiday Port",
                              "☃️ • Skin 11 Romantic Port", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 12 then
        MaxJP = gg.choice({"🎲 • Decoration 1", "🎲 • Decoration 2", "🎲 • Valentine's Day",
                           ...
                           "🎲 • China", "🎲 • Event Decoration", "🎲 • Kids Decoration",
                           "🎲 • Extra decor", "🎲 • Expedition", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
        if MaxJP == nil then
            return
        end
        if MaxJP == 1 then
    ...
    elseif menu_tipo == 129 then
        MaxWSFP = gg.choice({"🎲 • The Discobolus", "🎲 • Statue of Triumph", "🎲 • Dedicated Artists",
                             ...
                             "🎲 • Fruit Artist", "🎲 • The Magnificent Three",
                             "🎲 • Adrenaline attraction", "🎲 • Statue of a great leader", "❌ • Return"},
            nil, "CHOOSE ONE OPTION")
        if MaxWSFP == nil then
            return
        end
    ...
    elseif menu_tipo == 136 then
        MaTPKi = gg.choice({"🎲 • Mechanical Scarecrow", "🎲 • Remote Control Car Racing",
                            ...
                            "🎲 • Ultimate Console", "🎲 • Octopus Merry-Go-Round", "❌ • Return"}, nil,
            "CHOOSE ONE OPTION")
        if MaTPKi == nil then
            return
        end
    ...
    elseif menu_tipo == 137 then
        ExtraDcr = gg.choice({"🎲 • Extra decor 1", "🎲 • Extra decor 2", "🎲 • Extra decor 3",
                              "❌ • Return"}, nil, "CHOOSE ONE OPTION")
        if ExtraDcr == nil then
            return
        end
        if ExtraDcr == 1 then
            hack("extradcr1")
    ...
    elseif menu_tipo == 5360 then
        MNCvSW = gg.choice({'🎫 • Turtle Island Queen Expedition', '🎫 • Cleopatras Secret Spa Expedition',
                            '🎫 • Guardian of the North Expedition', '🎫 • Pirate Odyssey Expedition',
                            '🎫 • Yeti Megalith Expedition', '🎫 • Botanical Amusement Park Expedition',
                            '🎫 • Poseidons Kingdom Museum Expedition',
                            '🎫 • Institute of Natural Phenomena Expedition', '🎫 • Central Park Expedition',
                            '🎫 • Chinese Community Center Expedition', '🎫 • Rainbow Ecopark Expedition',
                            '🎫 • Food Tour Expedition', '🎫 • Agricultural Fair Expedition',
                            '🎫 • Sports Complex Expedition', '🎫 • Penguin Corner Expedition',
                            '🎫 • Classic Disco Expedition', '🎫 • Craft Fair Grounds Expedition',
                            '🎫 • Placid Camp Expedition', '🎫 • Beach Party Expedition',
                            '🎫 • Heart of Italy Expedition', '🎫 • Smart Mansion Expedition',
                            '🎫 • Golden Deer Cottage Expedition', '🎫 • Ice Lotus Fountain Expedition',
                            '🎫 • Classic Theater Expedition', '🎫 • Queen Wasp Greenhouse Expedition',
                            '🎫 • Space Research Center Expedition', '🎫 • Tree Library Expedition',
                            '🎫 • Glamping in Nature Expedition', '🎫 • Cosmic Cafeteria Expedition',
                            '🎫 • Primates Water Park Expedition', '🎫 • Eden in the Mountains Expedition',
                            '🎫 • Sugary Amusement Park Expedition', '🎫 • Halloween Windmill Expedition',
                            '🎫 • Expedición Portal de ciberópolis', '🎫 • Expedición Oficina del sheriff',
                            '❌ • Return'}, nil, 'CHOOSE ONE OPTION')
        if MNCvSW == nil then
            return
        end
...
function menuAvatars()
    MAVATR = gg.choice({'🏭 • 1 year', '🏭 • 2 years', '🏭 • 3 years', '🏭 • 4 years',
                        '🏭 • 5 years', '🏭 • 6 years', '🏭 • 7 years', '🏭 • 8 years',
                        '🏭 • 9 years', '🏭 • 10 years', '🏭 • 11 years', '🏭 • ava 1',
                        '🏭 • ava 2', '🏭 • ava 3', '🏭 • ava 4', '🏭 • ava 5', '🏭 • ava 6',
                        '🏭 • ava 7', '🏭 • ava 8', '🏭 • ava 9', '🏭 • ava 10', '🏭 • ava 11',
                        '🏭 • ava 12', '🏭 • ava 13', '🏭 • ava 14', '🏭 • ava 15', '🏭 • ava 16',
                        '🏭 • ava 17', '🏭 • ava 18', '🏭 • ava 19', '🏭 • ava 20', '🏭 • ava 21',
                        '🏭 • ava 22', '🏭 • ava 23', '🏭 • ava 24', '🏭 • ava 25', '🏭 • ava 26',
                        '🏭 • ava 27', '🏭 • ava 28', '🏭 • ava 29', '🏭 • ava 30', '🏭 • ava 31',
                        '🏭 • ava 32', '🏭 • ava 33', '🏭 • ava 325', '🏭 • ava 326',
                        '🏭 • ava 330', '🏭 • ava 333', '🏭 • ava 334', '🏭 • ava 335',
                        '🏭 • ava 339', '🏭 • ava 341', '🏭 • ava 347', '🏭 • ava 350',
                        '🏭 • ava 354', '🏭 • ava 355', '🏭 • ava 358', '🏭 • ava 363',
                        ...
                        '🏭 • ava 289', '🏭 • ava 292', '🏭 • ava 293', '🏭 • ava 296',
                        '🏭 • ava 297', '🏭 • ava 299', '🏭 • ava 306', '🏭 • ava 308',
                        '🏭 • ava 315', '🏭 • ava 105', '🏭 • ava 1', '🏭 • ava 73', '🏭 • ava 23',
                        '🏭 • ava 45', '🏭 • ava 25', '🏭 • ava 264', '🏭 • ava 348', '🏭 • ava 67',
                        '🏭 • ava 83', '🏭 • ava 4', '🏭 • ava 254', '🏭 • ava 63', '🏭 • ava 90',
                        '🏭 • ava 91', '🏭 • ava 302', '🏭 • ava 305', '🏭 • ava 307',
                        '🏭 • ava 318', '🏭 • ava 321', '🏭 • ava 242', '🏭 • ava 243', '❌ • Volver'},
        nil)
    if MAVATR == nil then
        return
    end
...
function menuStickers()
    SDIF = gg.choice({'1 • Sticker menu 1', '2 • Sticker menu 2', '❌ • Return'}, nil)
    ...
    if SDIF == 2 then
        MSTICKx = gg.choice(
            {'🌟 • Sticker 1x', '🌟 • Sticker 2x', '🌟 • Sticker 3x', '🌟 • Sticker 4x',
             ...
             '🌟 • Sticker 41x', '🌟 • Sticker 42x', '🌟 • Sticker 43x', '🌟 • Sticker 44x',
             '🌟 • Sticker 45x', '🌟 • Sticker 46x', '🌟 • Sticker 47x', '🌟 • Sticker 48x',
             '🌟 • Sticker 49x', '🌟 • Sticker 50x', '❌ • Volver'}, nil)
        if MSTICKx == nil then
            return
        end
        if MSTICKx == 1 then
...
function menuSign()
    MCARTE = gg.choice({'💎 • Fountain Sign', '💎 • Aloha Sign', '💎 • Aviator Sign',
                        ...
                        '💎 • Christmas Sign', '💎 • Large Halloween Sign', '💎 • City Day Sign',
                        '💎 • Farmer Card', '💎 • City of Lights Card', '💎 • City of Dreams Card',
                        '💎 • Ancestral Card', '💎 • Stone Card', '💎 • Zero Card', '💎 • Easter Card',
                        '💎 • Paranormal Card', '💎 • Inflatable Monster Card', '💎 • Snowboard Card',
                        '💎 • Bubblegum World Card', '💎 • Beach Bar Card', '💎 • Sweet Home Card',
                        '💎 • Story Card', '💎 • Rocker Card', '💎 • Card 26', '💎 • Card 27',
                        '💎 • Card 28', '💎 • Card 29', '💎 • Card 30', '💎 • Card 31',
                        '💎 • Card 32', '💎 • Card 33', '💎 • Card 34', '💎 • Card 35',
                        '💎 • Card 36', '💎 • Card 37', '💎 • Card 38', '💎 • Card 39',
                        '💎 • Card 40', '💎 • Card 41', '💎 • Card 42', '💎 • Card 43',
                        '💎 • Card 44', '💎 • Carte 45', '💎 • Card 46', '💎 • Card 47', '❌ • Back'},
        nil)
...
function menuPoster1()
    local options = {"1 • Fountain Sign", "2 • Aloha Sign", "3 • Aviator Sign", "4 • Big Screen Sign",
                     ...
                     "54 • Card 46", "55 • Card 47", "56 • Back"}

    -- Tạo bảng ánh xạ index → function
    local cartelFunctions = {}
    for i = 1, 55 do
        cartelFunctions[i] = _G["Cartel_" .. i]
    end

    local MCARTE = gg.choice(options, nil)

    if MCARTE == nil then
        return
    elseif MCARTE >= 1 and MCARTE <= 55 then
        if cartelFunctions[MCARTE] then
            cartelFunctions[MCARTE]()
        end
...
function hack15cD()
    ...
    gg.processResume()
    gg.clearResults()
    gg.searchNumber("1852990758;1752461929;49;29:185", gg.TYPE_DWORD)
...
function CartelSetValue(val_1, val_2, val_3, val_4, val_5, val_6)
    gg.toast("Loading...")
    gg.processResume()
    gg.clearResults()
    gg.setVisible(false)
...
function hack(variacao)
    ...
    elseif variacao == "extradcr1" then
        setd(-48, 0)
        setd(-44, 5)
        setd(-52, "00007473h")
        setd(-56, "65770074h")
    ...
    elseif variacao == "extradcr2" then
        setd(-48, 0)
        setd(-44, 5)
        setd(-52, "00000065h")
        setd(-56, "6C747475h")
    ...
    elseif variacao == "extradcr3" then
        setd(-48, 0)
        setd(-44, 5)
        setd(-52, "0000656Ch")
        setd(-56, "676E756Ah")
