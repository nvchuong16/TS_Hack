...
-- =========================
-- Password + Fixed Date License
-- Start: 29/08/2025 00:00
-- Expire: 26/09/2025 23:59
-- =========================

local PASSWORD = "TechTBR@2025"

-- Fixed license window
local START_DATE = {
    year = 2025,
    month = 8,
    day = 25,
...
local startTime = os.time(START_DATE)
local endTime = os.time(END_DATE)
local now = os.time()
...
if now < startTime then
    die("License not active yet!\nValid from 25/08/2025")
elseif now > endTime then
    die("License expired!\nExpired on 22/09/2025")
end

-- Days left calculation
local daysLeft = math.floor((endTime - now) / 86400)

-- Ask for password
local input = gg.prompt({"Enter Password (Days left: " .. tostring(daysLeft) .. ")"}, {""}, {"text"})

if not input or input[1] ~= PASSWORD then
    die("Wrong password!")
end

gg.toast("Access granted. License valid for " .. daysLeft .. " more days.")

-- =========================
-- Aapki main script yahan se start hogi
-- =========================
...
function menuescolhas2(menu_tipo)
    SalvarUltimoMenu(menu_tipo) -- Salva o menu atual antes de exibir
    if menu_tipo == 1 then
        MNV = gg.choice({'🌟 • Unlock Gold Pass', '⏳ • Freeze Reward', '💣 • Items', "🎉 • Skins",
                         "🏠 • Decoration", '🎫 • Coupons', '🍂 • Crop Time', '🎯 • Avatar',
                         '⚓ • Stickers', '🏭 • Poster', "☢️ • More", '❌ • Back'}, nil,
            [[︵‿︵‿୨♡୧‿︵‿︵  
💠 𝑻𝒐𝒘𝒏𝒔𝒉𝒊𝒑 𝑺𝒄𝒓𝒊𝒑𝒕 💠  
💠 𝑺𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝑻𝒆𝒄𝒉 𝑻𝑩𝑹 💠  
︵‿︵‿୨♡୧‿︵‿︵]])
    ...
    elseif menu_tipo == 2 then
        MNZ = gg.choice({'💣 • Mine', '🏭 • Construction', '🌟 • Gems', '💎 • Ingots',
                         "🎁 • ADVANTAGE HACK", "🚀 • BOOSTER LAB HACK", "🚀 • BOOSTER MINIGAME HACK",
    ...
    elseif menu_tipo == 551 then
        MAVATR = gg.choice({'🏭 • 1 year', '🏭 • 2 years', '🏭 • 3 years', '🏭 • 4 years',
                            ...
                            '🏭 • 9 years', '🏭 • 10 years', '🏭 • 11 years', '🏭 • ava 1',
                            '🏭 • ava 2', '🏭 • ava 3', '🏭 • ava 4', '🏭 • ava 5', '🏭 • ava 6',
                            '🏭 • ava 7', '🏭 • ava 8', '🏭 • ava 9', '🏭 • ava 10', '🏭 • ava 11',
                            '🏭 • ava 12', '🏭 • ava 13', '🏭 • ava 14', '🏭 • ava 15',
                            '🏭 • ava 16', '🏭 • ava 17', '🏭 • ava 18', '🏭 • ava 19',
                            '🏭 • ava 20', '🏭 • ava 21', '🏭 • ava 22', '🏭 • ava 23',
                            '🏭 • ava 24', '🏭 • ava 25', '🏭 • ava 26', '🏭 • ava 27',
                            '🏭 • ava 28', '🏭 • ava 29', '🏭 • ava 30', '🏭 • ava 31',
                            '🏭 • ava 32', '🏭 • ava 33', '🏭 • ava 325', '🏭 • ava 326',
                            '🏭 • ava 330', '🏭 • ava 333', '🏭 • ava 334', '🏭 • ava 335',
                            '🏭 • ava 339', '🏭 • ava 341', '🏭 • ava 347', '🏭 • ava 350',
                            '🏭 • ava 354', '🏭 • ava 355', '🏭 • ava 358', '🏭 • ava 363',
                            '🏭 • ava 366', '🏭 • ava 369', '🏭 • ava 374', '🏭 • ava 381',
                            '🏭 • ava 294', '🏭 • ava 153', '🏭 • ava 196', '🏭 • ava 238',
                            '🏭 • ava 246', '🏭 • ava 256', '🏭 • ava 265', '🏭 • ava 276',
                            '🏭 • ava 277', '🏭 • ava 283', '🏭 • ava 284', '🏭 • ava 288',
                            '🏭 • ava 289', '🏭 • ava 292', '🏭 • ava 293', '🏭 • ava 296',
                            '🏭 • ava 297', '🏭 • ava 299', '🏭 • ava 306', '🏭 • ava 308',
                            '🏭 • ava 315', '🏭 • ava 105', '🏭 • ava 1', '🏭 • ava 73',
                            '🏭 • ava 23', '🏭 • ava 45', '🏭 • ava 25', '🏭 • ava 264',
                            '🏭 • ava 348', '🏭 • ava 67', '🏭 • ava 83', '🏭 • ava 4',
                            '🏭 • ava 254', '🏭 • ava 63', '🏭 • ava 90', '🏭 • ava 91',
                            '🏭 • ava 302', '🏭 • ava 305', '🏭 • ava 307', '🏭 • ava 318',
                            '🏭 • ava 321', '🏭 • ava 242', '🏭 • ava 243', '❌ • Volver'}, nil,
            'CHOOSE ONE OPTION')
        if MAVATR == nil then
            return
        end
    ...
    elseif menu_tipo == 552 then
        SDIF = gg.choice({'🏭 • Sticker menu 1', '🏭 • Sticker menu 2', '❌ • Return'}, nil,
            'CHOOSE ONE OPTION')
    ...
    elseif menu_tipo == 553 then
        MCARTE = gg.choice({'💎 • Fountain Sign', '💎 • Aloha Sign', '💎 • Aviator Sign',
                            '💎 • Big Screen Sign', '💎 • Old Ranch Sign', '💎 • Windmill Sign',
                            '💎 • Mechanical Sign', '💎 • Cactus Sign', '💎 • Artisan Sign',
                            '💎 • Flower Sign', '💎 • Awesome Sign', '💎 • Musical Sign',
                            '💎 • Luminous Sign', '💎 • Neon Sign', '💎 • Wild West Sign',
                            '💎 • Christmas Sign', '💎 • Large Halloween Sign', '💎 • City Day Sign',
                            '💎 • Farmer Card', '💎 • City of Lights Card', '💎 • City of Dreams Card',
                            '💎 • Ancestral Card', '💎 • Stone Card', '💎 • Zero Card',
                            '💎 • Easter Card', '💎 • Paranormal Card', '💎 • Inflatable Monster Card',
                            '💎 • Snowboard Card', '💎 • Bubblegum World Card', '💎 • Beach Bar Card',
                            '💎 • Sweet Home Card', '💎 • Story Card', '💎 • Rocker Card',
                            '💎 • Card 26', '💎 • Card 27', '💎 • Card 28', '💎 • Card 29',
                            '💎 • Card 30', '💎 • Card 31', '💎 • Card 32', '💎 • Card 33',
                            '💎 • Card 34', '💎 • Card 35', '💎 • Card 36', '💎 • Card 37',
                            '💎 • Card 38', '💎 • Card 39', '💎 • Card 40', '💎 • Card 41',
                            '💎 • Card 42', '💎 • Card 43', '💎 • Card 44', '💎 • Carte 45',
                            '💎 • Card 46', '💎 • Card 47', '❌ • Back'}, nil, 'CHOOSE ONE OPTION')
    ...
    elseif menu_tipo == 3 then
        MNZ = gg.choice({'🐶 • Animals', '💣 • Forge', '💣 • Cow Feed Mill', '💣 • Chicken Feed Mill',
                         '💣 • Sheep Feed Mill', '❌ • Return'}, nil, [[︵‿︵‿୨♡୧‿︵‿︵  
💠 𝑻𝒐𝒘𝒏𝒔𝒉𝒊𝒑 𝑺𝒄𝒓𝒊𝒑𝒕 💠  
💠 𝑺𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝑻𝒆𝒄𝒉 𝑻𝑩𝑹 💠  
︵‿︵‿୨♡୧‿︵‿︵]])
    ...
    elseif menu_tipo == 5 then
        MNC = gg.choice({'🎫 • Order Coupon', '🎫 • Expansion Coupon', '🎫 • Granary Coupon',
                         ...
                         '🎫 • Merchant Coupon', '❌ • Return'}, nil, 'CHOOSE ONE OPTION')
    ...
    elseif menu_tipo == 6 then
        MNF = gg.choice({'🍀 • XP (Wheat)', '📦 • City Market', '🏭 • Industry Academy',
                         ...
                         '🛬📦 • XP Plane If it doesnt work 1/9 boxes', '🛬📦 • Ask for help plane 9 boxes',
                         '🛬 • Plane return to base', '🚀 • Heli Auto', '💺 • Airplane Auto',
                         '👾 • Freeze Population', '❌ • Return'}, nil, [[︵‿︵‿୨♡୧‿︵‿︵  
💠 𝑻𝒐𝒘𝒏𝒔𝒉𝒊𝒑 𝑺𝒄𝒓𝒊𝒑𝒕 💠  
💠 𝑺𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝑻𝒆𝒄𝒉 𝑻𝑩𝑹 💠  
︵‿︵‿୨♡୧‿︵‿︵]])
    ...
    elseif menu_tipo == 10 then
        FGds = gg.choice({'💎 • Bronze Ingot', '💎 • Silver Ingot', '💎 • Gold Ingot',
                          '💎 • Platinum Ingot', '❌ • Return'}, nil, 'CHOOSE ONE OPTION')
    ...
    elseif menu_tipo == 11 then
        MaxJE = gg.choice({"🛰️ • Skin 1 Castle", "🚀 • Skin 2 Helicopter", "⚓ • Skin 3 Helipad",
                           ...
                           "☃️ • Skin 13 Pigs", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
        if MaxJE == nil then
            return
        end
        if MaxJE == 1 then
    ...
    elseif menu_tipo == 101 then
        MaxJES_1 = gg.choice({"🛰️ • Skin 1 Gatsby Island Palace", "🚀 • Skin 2 Gatsby Island Mansion",
                              ...
                              "☃️ • Skin 9 Aztec Island", "🚁 • Skin 10 Castle", "☃️ • Skin 11 Castle",
                              "🚁 • Skin 12 Castle", "☃️ • Skin 13 Castle", '❌ • Return'}, nil,
            "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 102 then
        MaxJES_2 = gg.choice({"🚁 • Skin 1 Helicopter", "🚁 • Skin 2 Delivery Robot",
                              "🚁 • Skin 3 Santa's Little Helper's Sleigh", "🚁 • Skin 4 Flying Saucer",
                              "🚁 • Skin 5 Flying Carpet", "🚁 • Skin 6 Lounger Drone",
                              "🚁 • Skin 7 Flying Boat", "🚁 • Skin 8 Private Helicopter",
                              "🚁 • Skin 9 Club Helicopter", "🚁 • Skin 10 Feathered Helicopter",
                              "🚁 • Skin 11 Space Helicopter", "🚁 • Skin 12 Gala Helicopter",
                              "🚁 • Skin 13 Helicopter", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
        ...
        if MaxJES_2 == 11 then
            HelicotEspacial("riacJR_1")
        end
        if MaxJES_2 == 12 then
            HelicotGala("riacJR_2")
        end
        if MaxJES_2 == 13 then
            menuescolhas2(113)
        end
    ...
    elseif menu_tipo == 103 then
        MaxJES_3 = gg.choice({"🚁 • Skin 1 disco helipad", "🚁 • Skin 2 Space helipad",
                              "🚁 • Skin 3 Helipad Gala", "🚁 • Skin 4 helipad", "🚁 • Skin 5 helipad",
                              "🚁 • Skin 6 helipad", "🚁 • Skin 7 helipad", "🚁 • Skin 8 helipad",
                              "🚁 • Skin 9 helipad", "🚁 • Skin 10 helipad", "🚁 • Skin 11 helipad",
                              "🚁 • Skin 12 helipad", "🚁 • Skin 13 helipad", '❌ • Back'}, nil,
            "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 104 then
        MaxJES_4 = gg.choice({"🛰️ • Skin 1 Christmas Train", "🚀 • Skin 2 Ghost Train",
                              ...
                              "☃️ • Skin 13 Disco Train", "☃️ • Skin 14 Floral Train", '❌ • Return'},
            nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 105 then
        MaxJES_5 = gg.choice({"🛰️ • Express Gate Station Skin 1", "🚀 • Haunted Station Skin 2",
                              ...
                              "🛬 • Train Station Skin 5", "🚁 • Train Station Skin 6",
                              "☃️ • Train Station Skin 7", "🚁 • Train Station Skin 8",
                              "☃️ • Train Station Skin 9", "🚁 • Train Station Skin 10",
                              "☃️ • Train Station Skin 11", "🚁 • Train Station Skin 12",
                              "☃️ • Train Station Skin 13", "☃️ • Train Station Skin 14", '❌ • Back'},
            nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 106 then
        MaxJES_6 = gg.choice({"🛬 • Skin 1 Rocket Plane", "🛬 • Skin 2 Super Rocket Plane",
                              "🛬 • Skin 3 Supersonic Dragon Plane", "🛬 • Skin 4 Space Rocket Plane",
                              "🛬 • Skin 5 Rock Plane", "🛬 • Skin 6 Aero Plane Plane",
                              "🛬 • Skin 7 Frosted Plane", "🛬 • Skin 8 Lucky Plane",
                              "🛬 • Skin 9 Arabian Plane", "🛬 • Skin 10 Fashion Plane",
                              "🛬 • Skin 11 Stealth Aircraft", "🛬 • Skin 12 Airplane",
                              "🛬 • Skin 13 Airplane", '❌ • Back'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 107 then
        MaxJES_7 = gg.choice({"🛬 • Skin 1 Rock Airport", "🛬 • Skin 2 Sweet Airport",
                              ...
                              "🛬 • Skin 9 Rainbow Airport", "🛬 • Skin 10 Airport", "🛬 • Skin 11 Airport",
                              "🛬 • Skin 12 Airport", "🛬 • Skin 13 Airport", '❌ • Return'}, nil,
            "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 108 then
        MaxJES_8 = gg.choice({"🛰️ • Skin 1 Barco Crucero", "🚀 • Skin 2 Barco Birreme griego",
                              "⚓ • Skin 3 Barco Vikingo", "🎯 • Skin 4 Barco de Vapor",
                              "🛬 • Skin 5 Barco Ártico", "🚁 • Skin 6 Barcos", "☃️ • Skin 7 Barcos",
                              "🚁 • Skin 8 Barcos", "☃️ • Skin 9 Barcos", "🚁 • Skin 10 Barcos",
                              "☃️ • Skin 11 Barcos", "🚁 • Skin 12 Barcos", "☃️ • Skin 13 Barcos",
    ...
    elseif menu_tipo == 109 then
        MaxJES_9 = gg.choice({"🛰️ • Tropical Port Skin 1", "🚀 • Pirate Port Skin 2",
                              "⚓ • Classic Port Skin 3", "🎯 • Jungle Port Skin 4",
                              "🛬 • Viking Port Skin 5", "🚁 • Port Skin 6", "☃️ • Port Skin 7",
                              "🚁 • Port Skin 8", "☃️ • Port Skin 9", "🚁 • Port Skin 10",
                              "☃️ • Port Skin 11", "🚁 • Port Skin 12", "☃️ • Port Skin 13",
                              '❌ • Back'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 110 then
        MaxJES_110 = gg.choice({"🛰️ • Skin 1 Festive Hen", "🚀 • Skin 2 Hen with Chiton",
                                ...
                                "☃️ • Skin 13 Hens", '❌ • Return'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 111 then
        MaxJES_111 = gg.choice({"🛰️ • Corsair Cow Skin 1", "🚀 • Elegant Cow Skin 2",
                                ...
                                "☃️ • Cow Skin 11", "🚁 • Cow Skin 12", "☃️ • Cow Skin 13",
                                '❌ • Return'}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 12 then
        MaxJP = gg.choice({"🎲 • Decoration 1", "🎲 • Decoration 2", "🎲 • Valentine's Day",
                           "🎲 • Christmas", "🎲 • Halloween", "🎲 • The First", "🎲 • Sports",
                           "🎲 • Airplane", "🎲 • Candy", "🎲 • Ruins", "🎲 • Townshi Statues",
                           "🎲 • Tree", "🎲 • Inflatable", "🎲 • Puzzle", "🎲 • Diamonds",
                           "🎲 • China", "🎲 • Event Decoration", "🎲 • Kids Decoration", "❌ • Return"},
            nil, "CHOOSE ONE OPTION")
        if MaxJP == nil then
            return
        end
    ...
    elseif menu_tipo == 1220 then
        MaxJTyMT = gg.choice({"🎲 • Walk of Fame", "🎲 • Venetian Bridge", "🎲 • Transformation Studio",
                              ...
                              "🎲 • Maxi Blender", --
        "🎲 • Macedonian Parterre", --
        "🎲 • Stilt Dance", "🎲 • Loch Ness Monster", "🎲 • Haunted Ship", "🎲 • Diplodocus",
                              "🎲 • Galloping", "🎲 • Stonehenge", "🎲 • Waterfall", "🎲 • Hourglass",
                              "🎲 • Peacock Statue", "🎲 • Atlantean Trident", "🎲 • Pixies", --
        "🎲 • Statue Sea Relic", "🎲 • Coral Corner", "🎲 • Sea Explorers", "🎲 • Lily Pad Fairy", --
        "🎲 • Treasure Keeper", "🎲 • Falconry", "🎲 • Ghost Ship", "🎲 • Carnivorous Plant",
                              "🎲 • Flower Swing", --
        "🎲 • Cocoloco Beach Bar", "🎲 • Surf Pool", "🎲 • Bungalow", "🎲 • Palm Tree Seesaw",
                              "🎲 • Farmer's Totem", "🎲 • Scribe's Workshop", "🎲 • Naval Cannon",
                              "🎲 • Flower Palette", "🎲 • Magic Tap", "🎲 • Music Fountain",
                              "🎲 • Gramophone Carousel", "🎲 • Set Filming", "🎲 • Movie Fountain",
                              "🎲 • Music Store", "🎲 • Pharaoh Statue", "🎲 • Papyrus Boat",
                              "🎲 • Trojan Horse", "🎲 • Amphitheater", "🎲 • Arabian Horse",
                              "🎲 • Swan Pond", "🎲 • Weeping Willow", "🎲 • Fallen Tree",
                              "🎲 • Waterfall", "🎲 • Satellite Station", "🎲 • Parisian Square",
                              "🎲 • Bike Parking", "🎲 • Bookstore", "🎲 • Flower Boutique",
                              "🎲 • Giant Synthesizer", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 1350 then
        MaxDECORT = gg.choice({"🎲 • Dancing Fountain", "🎲 • Water Slide", "🎲 • Outdoor Pizzeria",
                               ...
                               "🎲 • Exotic Snack Bar", "🎲 • Fruit Assortment",
                               "🎲 • Floral Fairy Fountain", "🎲 • Rainbow Factory",
                               "🎲 • Milkshake Pyramid", "🎲 • Natural Wonder Work of Art",
                               "🎲 • Inflatable Challenge", "🎲 • Monster Truck", "🎲 • Around the World",
                               "🎲 • Kingdom Center", "🎲 • Curlin", "🎲 • Book of Nature",
                               "🎲 • The Sea Trotter", "🎲 • Macedonian Parterre", "❌ • Return"}, nil,
            "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 120 then
        MaxJTyP = gg.choice({"❤ • Cat Love Statue", "❤️ • Care Bear", "❤️ • Romantic Date",
                             ...
                             "❤️ • Cupid's Eye", "❤️ • Ideal Couple Photocall",
                             "❤️ • Mini Park romantic", "❤️ • carriage", "❤️ • Bridal Bouquet",
                             "❤️ • Eternal Love", "❤️ • Fairytale Rose", "❌ • Return"}, nil,
            "CHOOSE ONE OPTION")
        if MaxJTyP == nil then
            return
        end
    ...
    elseif menu_tipo == 121 then
        MaxJTyM = gg.choice({"🎲 • Ice Rink", "🎲 • Christmas Carousel", "🎲 • Festive Lamppost",
                             ...
                             "🎲 • Santa's House", "🎲 • Ice Slide", "🎲 • Toboggan Run",
                             "🎲 • Sled Dogs", "🎲 • Frozen Tyrannosaurus", "🎲 • Polar Station",
                             "🎲 • Cable Car", "🎲 • Ice Reindeer", "🎲 • Ice Castle",
                             "🎲 • Snow Globe", "🎲 • Frozen Mammoth", "🎲 • Icebreaker Ship",
                             "🎲 • Penguin Land", "🎲 • Arctic Glacier", "🎲 • Christmas Stocking",
                             "🎲 • Christmas Tree", "🎲 • Gift Mountain", "🎲 • Ice Dragon",
                             "🎲 • Elf House", "🎲 • Snowman", "🎲 • Christmas Ball",
                             "🎲 • Meeting Santa Claus Poster", "🎲 • Winter Sports",
    ...
    elseif menu_tipo == 123 then
        MaxJTyMTRE = gg.choice({"🎲 • Ominous Fountain", "🎲 • Black Cat", "🎲 • Witch with Potion",
                                ...
                                "🎲 • Werewolf Spectacle", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 124 then
        MaxJTyCFMT = gg.choice({"🎲 • The first geneticist", "🎲 • The first tourist",
                                "🎲 • The first thinker", "🎲 • The first firefighter",
                                "🎲 • The first commander", "🎲 • The first policeman",
                                "🎲 • The first musician", "🎲 • The first painter",
                                "🎲 • The first soccer player", "🎲 • The first scientist",
                                "🎲 • The first balloonist", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 128 then
        MaxPOYUT = gg.choice({"🎲 • Lost City Gate", "🎲 • Ancient Ruins", "🎲 • Ancestral Statue",
                              ...
                              "🎲 • Ancient Calendar", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 129 then
        MaxWSFP = gg.choice({"🎲 • The Discobolus", "🎲 • Statue of Triumph", "🎲 • Dedicated Artists",
                             ...
                             "🎲 • Fruit Artist", "🎲 • The Magnificent Three", "❌ • Return"}, nil,
            "CHOOSE ONE OPTION")
        if MaxWSFP == nil then
            return
        end
    ...
    elseif menu_tipo == 130 then
        MaxBHSO = gg.choice({"🎲 • Jacaranda", "🎲 • Cactus", "🎲 • Baobab", "🎲 • Date Palm",
                             "🎲 • Wisteria", "🎲 • Delonix regia", "🎲 • Araguaney",
                             "🎲 • Rhododendron", "🎲 • Gladioli", "🎲 • Poppies",
                             "🎲 • Field of Flowers", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
        if MaxBHSO == nil then
            return
        end
        if MaxBHSO == 1 then
    ...
    elseif menu_tipo == 132 then
        MaxTPLKA = gg.choice({"🎲 • Land of the Dinosaurs", "🎲 • Spaceport", "🎲 • Snowman",
                              ...
                              "🎲 • Water Village", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 133 then
        MaxLFGJZ = gg.choice({"🎲 • St. Basil's Cathedral", "🎲 • Castle", "🎲 • Statue of Liberty",
                              ...
                              "🎲 • Triumphal Arch", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
    ...
    elseif menu_tipo == 135 then
        MaxFGJZ = gg.choice({"🎲 • Florist's House", "🎲 • House of Terror", "🎲 • Art Exhibition",
                             ...
                             "🎲 • Hotel Atlantida", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
        if MaxFGJZ == nil then
            return
        end
        if MaxFGJZ == 1 then
    ...
    elseif menu_tipo == 136 then
        MaTPKi = gg.choice({"🎲 • Mechanical Scarecrow", "🎲 • Remote Control Car Racing",
                            "🎲 • Fruit Cannon", "🎲 • Knife Throwing", "🎲 • Fruit Shooting Range",
                            "🎲 • Power Hammer", "🎲 • Pinball", "🎲 • Stuffed Animal Machine",
                            "🎲 • Ultimate Console", "❌ • Return"}, nil, "CHOOSE ONE OPTION")
        if MaTPKi == nil then
            return
        end
        if MaTPKi == 1 then
...
function hack25()
    ...
    -- Primeiro prompt
    ppls = gg.prompt({
        [1] = "¿Cantidad de población para desbloquear la siguiente tierra?"
    }, {
        [1] = "0"
    }, {
        [1] = "text"
...
function HackCons(variacE)
    gg.searchNumber("7498049;33;1599099684;1599099682", gg.TYPE_DWORD)
    ...
    local val_5 = {}
    val_5[1] = {
        address = r[1].address + 0x10,
        flags = gg.TYPE_DWORD
    }
    val_5 = gg.getValues(val_5)
    local val_6 = {}
    val_6[1] = {
        address = r[1].address + 0x14,
        flags = gg.TYPE_DWORD
    }
...
function HackGran(variacJE) -- HackCons
    gg.searchNumber("7498049;33;1599099684;1599099682", gg.TYPE_DWORD)
    gg.refineNumber("33", gg.TYPE_DWORD)

    local r = gg.getResults(2) -- load items
    ...
    if variacJE == "r2" then
        setd(-48, 0)
        setd(-44, 2000)
        setd(-52, val_6[2].value)
        setd(-56, val_5[2].value)
        setd(-60, val_4[2].value)
        setd(-64, val_3[2].value)
        setd(-68, val_2[2].value)
        setd(-72, val_1[2].value)
...
function HelipaDisco(variacJE)
    gg.searchNumber("00006F63h;6C65481Eh;706F6369h;50726574h;6563616Ch", gg.TYPE_DWORD)
    gg.refineNumber("6563616Ch", gg.TYPE_DWORD)
    local r = gg.getResults(1) -- load items
    local val_1 = {}
    val_1[1] = {
        address = r[1].address + 0x0C,
...
function HelipaEspacial(variacJE_1)
    gg.searchNumber("00006F63h;6C65481Eh;706F6369h;50726574h;6563616Ch", gg.TYPE_DWORD)
    gg.refineNumber("6563616Ch", gg.TYPE_DWORD)
    local r = gg.getResults(1) -- load items
    local val_1 = {}
    val_1[1] = {
        address = r[1].address + 0x20C,
        flags = gg.TYPE_DWORD
    }
    val_1 = gg.getValues(val_1) -- refresh items values
    local val_2 = {}
    val_2[1] = {
        address = r[1].address + 0x210,
        flags = gg.TYPE_DWORD
    }
    val_2 = gg.getValues(val_2)
    local val_3 = {}
    val_3[1] = {
        address = r[1].address + 0x214,
        flags = gg.TYPE_DWORD
    }
    val_3 = gg.getValues(val_3)
    local val_4 = {}
    val_4[1] = {
        address = r[1].address + 0x218,
        flags = gg.TYPE_DWORD
    }
    val_4 = gg.getValues(val_4)
    local val_5 = {}
    val_5[1] = {
        address = r[1].address + 0x21C,
        flags = gg.TYPE_DWORD
    }
    val_5 = gg.getValues(val_5)
    local val_6 = {}
    val_6[1] = {
        address = r[1].address + 0x220,
        flags = gg.TYPE_DWORD
    }
    val_6 = gg.getValues(val_6)
...
function HelipaGala(variacJE_2)
    gg.searchNumber("00006F63h;6C65481Eh;706F6369h;50726574h;6563616Ch", gg.TYPE_DWORD)
    gg.refineNumber("6563616Ch", gg.TYPE_DWORD)
    local r = gg.getResults(1) -- load items
    local val_1 = {}
    val_1[1] = {
        address = r[1].address - 0x2B4,
        flags = gg.TYPE_DWORD
    }
    val_1 = gg.getValues(val_1) -- refresh items values
    local val_2 = {}
    val_2[1] = {
        address = r[1].address - 0x2B0,
        flags = gg.TYPE_DWORD
    }
    val_2 = gg.getValues(val_2)
    local val_3 = {}
    val_3[1] = {
        address = r[1].address - 0x2AC,
        flags = gg.TYPE_DWORD
    }
    val_3 = gg.getValues(val_3)
    local val_4 = {}
    val_4[1] = {
        address = r[1].address - 0x2A8,
        flags = gg.TYPE_DWORD
    }
    val_4 = gg.getValues(val_4)
    local val_5 = {}
    val_5[1] = {
        address = r[1].address - 0x2A4,
        flags = gg.TYPE_DWORD
    }
    val_5 = gg.getValues(val_5)
    local val_6 = {}
    val_6[1] = {
        address = r[1].address - 0x2A0,
        flags = gg.TYPE_DWORD
    }
    val_6 = gg.getValues(val_6)
...
function HelicotEspacial(variacJR_1)
    gg.searchNumber("00006F63h;6C65481Eh;706F6369h;50726574h;6563616Ch", gg.TYPE_DWORD)
    gg.refineNumber("6563616Ch", gg.TYPE_DWORD)
    local r = gg.getResults(1) -- load items
    local val_1 = {}
...
function HelicotGala(variacJR_2)
    gg.searchNumber("00006F63h;6C65481Eh;706F6369h;50726574h;6563616Ch", gg.TYPE_DWORD)
    gg.refineNumber("6563616Ch", gg.TYPE_DWORD)
    local r = gg.getResults(1) -- load items
    local val_1 = {}
...
function hackTrEn()
    ...
    -- print('First 5 results: ', t)
    -- print('First result: ', t[1])
    -- print('First result address: 1', t[1].address)
    -- print('First result value: kk 1', t[1].value)
    -- print('First result type: ', t[1].flags)
...
function hack(variacao)
    ...
    elseif variacao == "Cas_9" then -- isla azteca
        ...
        setd(-68, "6F465F6Eh")
        setd(-72, "696B5328h")
    elseif variacao == "Cas_10" then -- isla azteca
        setd(-48, 0)
        setd(-44, 50)
        setd(-52, "00006769h")
        setd(-56, "625F6C61h")
